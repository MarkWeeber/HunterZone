...
namespace HunterZone.Space
{
    public class PlayerSettings : MonoBehaviour
    {
        ...
        private void Start()
        {
            playerNameInputField.text = LobbySingleton.Instance.LobbyManager.PlayerConfig.Name;
        }
        ...
        public void SavePlayerSettings()
        {
            if (playerNameInputField.text.Length >= minPlayerNameLength && playerNameInputField.text.Length <= maxPlayerNameLength)
            {
                if (ColorOptionUI.Color.a == 1)
                {
                    ...
                    LobbySingleton.Instance.LobbyManager.PlayerConfig.Name = playerNameInputField.text;
                    LobbySingleton.Instance.LobbyManager.PlayerConfig.Color = ColorOptionUI.Color;
